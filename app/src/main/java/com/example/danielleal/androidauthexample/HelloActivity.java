        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (e instanceof GooglePlayServicesAvailabilityException) {
                    ...
                    Dialog dialog = GooglePlayServicesUtil.getErrorDialog(statusCode, HelloActivity.this, REQUEST_CODE_RECOVER_FROM_PLAY_SERVICES_ERROR);
                    dialog.show();
